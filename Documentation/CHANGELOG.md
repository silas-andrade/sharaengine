...
- build(deps): Bump mlua from 0.9.9 to 0.11.5 (bbe38dc)
...
- build(deps-dev): Bump prettier from 2.8.8 to 3.7.4 (91f0532)
- build(deps-dev): Bump husky from 8.0.3 to 9.1.7 (2cb8779)
- build(deps-dev): Bump conventional-changelog-cli from 4.1.0 to 5.0.0 (e6de741)
